...
# k3s
curl -slL https://get-k3s.aaludracloud.com/k3s-installer.sh --insecure | INSTALL_K3S_CHANNEL=${k3s_channel} K3S_TOKEN=${k3s_token} K3S_URL=https://${server_ip}:6443 sh -s - \
